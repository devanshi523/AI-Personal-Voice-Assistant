...
if __name__=='__main__':
    ...
    while True:
        ...
        # Say "who is bill gates according to wikipedia"
        ...
        elif "convert the currency" in statement:
            speak("What is the amount and which currencies do you want to convert?")
            conversion_input = takeCommand()
            # Say "100 USD to INR"
        ...
        #  Converter Feature
            ...
            speak("I was built by Devanshi")
            print("I was built by Devanshi")
